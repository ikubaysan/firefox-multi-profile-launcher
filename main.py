...
def clone_template_profile(template_profile_dir, cloned_profiles_dir, profile_base_name, count: int, force: bool = False):
...
def run_firefox_with_cloned_profiles(cloned_profiles_dir):
    profile_paths = [os.path.abspath(os.path.join(cloned_profiles_dir, profile)) for profile in os.listdir(cloned_profiles_dir)]
...
def main(keep_script_running: bool, clone_count: int, force: bool, template_profile_dir, cloned_profiles_dir, profile_base_name):
    clone_template_profile(template_profile_dir, cloned_profiles_dir, profile_base_name, count=clone_count, force=force)
    processes = run_firefox_with_cloned_profiles(cloned_profiles_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cloned-dir", type=str, default=os.path.join(os.path.dirname(os.path.realpath(__file__)), "cloned_profiles"), help="Directory to store cloned profiles.")
    parser.add_argument("--profile-base-name", type=str, default="custom_profile", help="Base name for cloned profiles.")
    parser.add_argument("--keep-running", action="store_true", help="Keep the script running while Firefox processes are active.")
    ...
    main(keep_script_running=args.keep_running, clone_count=args.count, force=args.force, template_profile_dir=args.template_dir, cloned_profiles_dir=args.cloned_dir, profile_base_name=args.profile_base_name)
